...
import { getData, postData } from '../Controller/utils/fetchData'
...
const Cart = () => {
  ...
  useEffect(() => {
    const cartLocal = JSON.parse(localStorage.getItem('eshop_cart01'))
  ...
  const handlePayment = async (e) => {
    ...
    const res = await postData('order', { address, mobile, cart, total }, auth.token);
