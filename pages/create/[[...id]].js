...
import { postData, putData } from '../../Controller/utils/fetchData'
import { imageUpload } from '../../Controller/utils/imageUpload'
            ...
            <form className="row" onSubmit={handleSubmit}>
                <div className="col-md-6">
                    ...
                    <div className="input-group-prepend px-0 my-2">
                        <input type="category" name="category" id="category" value={category}
                            placeholder="Category" className="d-block w-100 p-2"
                            onChange={handleChangeInput} />
                    </div>
